      ...
      <div className='w-full h-5/6 flex items-center justify-between gap-3'>
        ...
        <div className='w-1/2 h-full flex flex-col justify-center gap-3 py-[3vh]'>
          ...
          <div ref={contentRef} className={`${jakartaSans.className} h-4/5 overflow-y-auto mb-5 pr-3`}>
            ...
            <ul>
              <li>a. Tercemarnya udara dari abu vulkanik. Gas di dalamnya seperti sulfur dioksida, nitrogen dioksida, hidrogen sulfida, dan partikel debu lain yang dapat membunuh makhluk hidup.</li>
              <li>b. Lumpuhnya berbagai kegiatan atau aktivitas manusia, rusaknya ekosistem, dan hancurnya berbagai bangunan.</li>
              <li>c. Material letusan gunung berapi berpotensi menyebabkan penyakit seperti ISPA (Infeksi Saluran Pernapasan Akut).</li>
            </ul>
            <br />
            <p className="font-bold">Dampak positif:</p>
            <ul>
              <li>a. Tanah menjadi subur dikarenakan telah dilalui abu vulkanik gunung berapi. Abu vulkanik mengandung mineral primer yang memiliki kandungan nutrisi yang melimpah dan baik bagi tanah.</li>
              <li>b. Tercipta mata pencaharian baru, yaitu penambang pasir dan bebatuan.</li>
              <li>c. Terdapat geyser (sumber mata air panas) yang sangat baik untuk kesehatan kulit manusia.</li>
            </ul>
            <div id="breakPoint3" />
            <div className='w-full h-0.5 bg-slate-300 my-[3vh]' />
            <p className="font-bold">Awas:</p>
            <ul>
              <li>a. Menandakan gunung berapi yang segera atau sedang meletus atau ada keadaan kritis yang menimbulkan bencana.</li>
            ...
            <ul>
              <li>a. Menandakan gunung berapi yang sedang bergerak ke arah letusan atau menimbulkan bencana.</li>
              <li>b. Peningkatan intensif kegiatan seismik.</li>
              <li>c. Semua data menunjukkan bahwa aktivitas dapat segera berlanjut ke letusan atau menuju pada keadaan yang dapat menimbulkan bencana.</li>
              <li>d. Jika tren peningkatan berlanjut, letusan dapat terjadi dalam waktu 2 minggu.</li>
            ...
            <ul>
              ...
              <li>d. Sedikit perubahan aktivitas yang diakibatkan oleh aktivitas magma, tektonik dan hidrotermal.</li>
