  ...
  return (
    <div className="relative h-[230px] lg:h-[480px] cursor-pointer" onClick={onClick}>
      <div className="h-full bg-black flex flex-col rounded-3xl relative z-[3]">
        ...
        >
          <div className="h-4 w-4 lg:h-10 lg:w-10 bg-[#D9D9D9] absolute left-1/2 -translate-x-1/2 grid place-content-center rotate-45 -bottom-1 lg:-bottom-5">
        ...
        <div className="h-[40%] w-full flex flex-col gap-y-1 relative z-[2] bg-black text-white rounded-b-3xl text-center lg:items-center lg:justify-center pt-3 px-4 lg:px-6 lg:py-2">
          <p className="font-otomanopee text-xs lg:text-3xl font-semibold">{title}</p>
          <p className={`${assistant.className} text-[8px]`}>{description}</p>
        </div>
      </div>
