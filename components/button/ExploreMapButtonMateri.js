...
export default function ExploreMapButtonMateri({ disaster }) {
  return (
    <Link href={`/peta?bencana=${disaster}`}>
      <button
        className={`w-fit flex items-center gap-x-2 ${caesarDressing.className} bg-[#29ADB2] text-white font-bold p-1 text-sm lg:py-2 lg:px-4 rounded-[10px] lg:text-2xl`}
      >
