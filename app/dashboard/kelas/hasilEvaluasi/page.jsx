  ...
  return (
    <div className={`w-screen h-screen flex ${jakartaSans}`}>
      <div className='w-full px-[5vh] py-[4vh] flex flex-col gap-8'>
        <div className="flex gap-4 items-center cursor-pointer" onClick={() => router.push('/dashboard/kelas')}>
          <IoArrowBackOutline size={24} color="black" />
          <button className="font-semibold text-xl">Hasil Evaluasi Aksa Padmarini</button>
        </div>
        ...
        <div className='w-[30%] flex flex-col rounded-[35px] border border-[#ECECEC] drop-shadow-xl bg-white'>
          <div className='flex flex-col my-[2vh] gap-3 px-[2vw] py-[1vh]'>
            ...
            <p className='text-sm text-[#4F4F4F]'>{benar}/{totalData}</p>
          </div>
